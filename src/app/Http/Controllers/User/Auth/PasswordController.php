...
use App\Http\Requests\User\Auth\SendEmailRequest;
...
class PasswordController extends Controller
{
    ...
    {
        return view('auth.user.reset_password.email_form');
    }
    ...
    public function sendEmailResetPassword(SendEmailRequest $request)
    {
        try {
            ...
            Log::info(__METHOD__ . '...ID:' . $user->id . 'のユーザにパスワード再設定用メールを送信しました。');
        } catch(Exception $e) {
            Log::error(__METHOD__ . '...ユーザーへのパスワード再設定メール送信に失敗しました。 request_email = ' . $request->email . ' error_message = ' . $e);
            return redirect()->route('user.password_reset.email.form')
        ...
        return redirect()->route('user.password_reset.email.send_complete');
    }
    ...
    public function sendComplete()
    {
        ...
        return view('auth.user.reset_password.send_complete');
    }
    ...
    public function edit(Request $request)
    {
        ...
        return view('auth.user.reset_password.edit')
    ...
    public function update(ResetPasswordRequest $request)
    {
        ...
        return redirect()->route('user.password_reset.edited');
    }
    ...
    public function edited()
    {
        ...
        return view('auth.user.reset_password.edited');
    }
}
