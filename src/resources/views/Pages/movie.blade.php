...
<div class="my-5">
    ...
    <ul class="tab_menu flex overflow-x-auto overflow-y-hidden border-b border-gray-200 whitespace-nowrap dark:border-gray-700 mt-5">
        <li class="tab_menu_item is_active inline-flex items-center h-10 px-4 -mb-px text-sm text-center bg-transparent border-b-2 sm:text-base whitespace-nowrap focus:outline-none cursor-pointer text-blue-600 border-blue-500" data-tab="01">
            コース内容
        </li>
        <li class="tab_menu_item inline-flex items-center h-10 px-4 -mb-px text-sm text-center bg-transparent border-b-2 sm:text-base whitespace-nowrap focus:outline-none cursor-pointer border-transparent hover:border-gray-400 text-gray-700" data-tab="02">
            Q & A
        </li>
    </ul>
    ...
    <div class="tab_panel mt-10">
        ...
        <div class="tab_panel_box hidden" data-panel="02">
            ...
            <a href="{{ route('comment.show', ['answerId' => 'answerId', 'commentId' => 'commentId', 'courseName' => 'courseName']) }}">
