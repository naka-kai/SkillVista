...
<div class="bg-white dark:bg-gray-900 py-8 lg:py-16 antialiased">
    ...
    @for ($i = 0; $i < 3; $i++)
        <div class="p-6 mb-3 text-base bg-white border-t border-gray-200 dark:border-gray-700 dark:bg-gray-900">
            <div class="flex justify-between items-center mb-2">
                ...
                <!-- 編集ボタン -->
                <button class="inline-flex items-center py-1 px-3 text-sm font-medium text-center text-gray-500 bg-gray-100 border rounded-sm hover:opacity-70"
    ...
    <!-- editor -->
    <div class="my-10">
        <form action="{{ route('comment.show', ['answerId' => 'answerId', 'commentId' => 'commentId', 'courseName' => 'courseName']) }}" id="form">
            @csrf
            ...
            <div class="flex justify-end mt-3">
                <button type="button" onclick="clickSubmit();" class="px-10 py-2 font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-600 rounded-sm hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80">送信</button>
            </div>
        </form>
    </div>
</div>
