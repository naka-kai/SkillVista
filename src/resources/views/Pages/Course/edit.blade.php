                            ...
                            <form
                                ...
                                <div>
                                    <div class="flex flex-col items-center justify-center mb-4 mt-3">
                                        <img src="{{ $course->thumbnail == null || '' ? asset('img/noimage.png') : asset($course->thumbnail) }}"
                                            alt=""
            ...
            <div class="mt-8">
                                                                ...
                                                                <div>
                                                                    <form
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            <label for="chapter{{ $chapter->id }}_movie"
                                                                                ...
                                                                                <h2 class="fileName mx-3 text-gray-400">
                                                                                    動画を選択してください</h2>
                                                                                <input
                                                                                    id="chapter{{ $chapter->id }}_movie"
                                                                                    type="file" name="movie"
                                                                        ...
                                                                        <div class="mt-5 flex flex-col">
                                                                            <label
                                                                                for="chapter{{ $chapter->id }}_movie_title"
                                                                                class="mb-1">動画タイトル</label>
                                                                            <input type="text"
                                                                                id="chapter{{ $chapter->id }}_movie_title"
                                                                                name="movie_title"
                ...
                <div class="w-full mt-10">
                    <div class="flex items-center w-4/5 justify-between mx-auto">
                        <a href="{{ route('course', ['courseName' => $course->course_url]) }}"
                            class="bg-blue-300 hover:opacity-70 py-3 px-5 text-center my-5 font-bold w-full m-7 rounded-md">表示を見てみる</a>
                        <a href="{{ route('teacher.myCourse', ['teacherName' => $course->teacher->last_name_en . $course->teacher->first_name_en]) }}"
