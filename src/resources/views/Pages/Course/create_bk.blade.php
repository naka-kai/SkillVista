            ...
            <div class="mt-10">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="mt-5 flex flex-col">
                                                                ...
                                                                <input type="text" id="chapter¥¥¥¥¥_movie_title"
                                                                    name="movie_title" value="¥¥¥¥¥" class="border p-1">
                                                            </div>
                                                            <button type="submit"
                ...
                @else
                    <div class="flex items-center my-5 w-full">
                        <input type="text" id="" name="" class="border w-full">
                        <label for="" class="ml-3">
                            <img src="{{ asset('img/add-chapter.png') }}" class="w-6">
                        </label>
                    </div>
                @endif
            </div>
