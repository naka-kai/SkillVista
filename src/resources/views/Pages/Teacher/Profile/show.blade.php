...
<div class="my-10">
    ...
    <div class="flex flex-col items-center justify-center">
        <figure class="w-full flex justify-center">
            <img class="object-cover w-36 h-36 rounded-full" src="{{ $teacher->image == null || "" ? asset('img/kkrn_icon_user_13.png') : asset($teacher->image) }}" alt="">
        </figure>
        ...
        <div id="imageModal" class="imageModal hidden fixed z-50 left-0 top-0 h-full w-full bg-[rgba(0,0,0,0.5)]">
            <div class="imageModal-content bg-white mx-auto my-[50%] w-1/2 lg:w-1/3 duration-300 transform ease-in-out p-6 rounded-sm">
                ...
                <div class="imageModal-body">
                    <form action="{{ route('teacher.profile.update', ['teacherName' => $teacher->last_name . $teacher->first_name]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <input type="hidden" name="id" value="{{ $teacher->id }}">
                        <div>
                            <div class="flex items-end mb-4 mt-3">
                                <img id="displayImg" src="{{ $teacher->image == null || "" ? asset('img/kkrn_icon_user_13.png') : asset($teacher->image) }}" alt="" class="w-24 h-24 rounded-full">
