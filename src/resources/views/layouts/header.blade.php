        ...
        <div class="container px-6 py-3 mx-auto">
            <div class="flex flex-col lg:flex-row lg:justify-between lg:items-center">
                ...
                <div x-cloak :class="[isOpen ? 'translate-x-0 opacity-100 ' : 'opacity-0 -translate-x-full']" class="absolute inset-x-0 z-20 px-6 py-2 transition-all duration-300 ease-in-out bg-white top-24 dark:bg-gray-800 lg:mt-0 lg:p-0 lg:top-0 lg:relative lg:bg-transparent lg:w-auto lg:opacity-100 lg:translate-x-0 flex flex-col lg:flex-row lg:items-center items-end hidden lg:flex">
                    ...
                    <!-- SP-notice -->
                    <button class="my-2 block lg:hidden text-gray-600 transition-colors duration-300 transform dark:text-gray-200 hover:text-gray-700 dark:hover:text-gray-400 focus:text-gray-700 dark:focus:text-gray-400 focus:outline-none hidden" aria-label="show notifications">
                    ...
                    <!-- SP-cart -->
                    <div class="my-2 flex lg:hidden justify-center hidden">
                    ...
                    <div class="items-end flex-col lg:flex-row lg:mx-1 hidden lg:flex">
