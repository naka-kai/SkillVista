        ...
        <div class="flex items-center w-full max-w-md px-6 mx-auto lg:w-2/3">
            <div class="flex-1">
                <div class="text-center">
                    <p class="mt-3 text-2xl font-semibold tracking-wider text-gray-700 capitalize">ユーザーパスワード再設定</p>
                </div>
                ...
                <div class="mt-8">
                    <form method="POST" action="{{ route('user.password_reset.email.send') }}">
                        @csrf
                        <div>
                    ...
                    <a class="block text-center mt-6 text-gray-600" href="{{ route('user.showLoginForm') }}">ログインページへ戻る</a>
                </div>
            </div>
        </div>
    </div>
