        ...
        <div class="flex items-center w-full max-w-md px-6 mx-auto lg:w-2/3">
            <div class="flex-1">
                <div class="text-center">
                    <p class="mt-3 text-2xl font-semibold tracking-wider text-gray-700 capitalize">ユーザーパスワードリセットメール送信完了</p>
                </div>

                <div class="mt-8 flex flex-col items-center">
                    <p class="text-gray-600">パスワードリセットメールを送信しました。</p>
                    <p class="text-gray-600">メールをご確認ください。</p>
