        ...
        <div class="flex items-center w-full max-w-md px-6 mx-auto lg:w-2/3">
            <div class="flex-1">
                <div class="text-center">
                    <p class="mt-3 text-2xl font-semibold tracking-wider text-gray-700 capitalize">ユーザーログイン</p>
                </div>
                ...
                <div class="mt-8">
                    <form method="POST" action="{{ route('user.login') }}">
                        ...
                        <div class="mt-6">
                            <div class="flex justify-between mb-2">
                                ...
                                <a href="{{ route('user.password_reset.email.form') }}" class="text-sm text-gray-400 focus:text-blue-500 hover:text-blue-500 hover:underline">パスワードをお忘れの方はこちら</a>
                            </div>
                    ...
                    <a href="{{ route('user.register') }}" class="block mt-6 text-sm text-center text-blue-500 focus:outline-none focus:underline hover:underline">まだアカウントをお持ちでない方はこちら</a>
                </div>
            </div>
        </div>
    </div>
