                ...
                <div class="flex-1">
                    ...
                    <div class="mt-8">
                        <form method="POST" action="{{ route('teacher.login') }}">
                            ...
                            <div>
                                <label for="email"
                                    class="block mb-2 text-sm text-gray-600 dark:text-gray-200">メールアドレス</label>
                                ...
                                <div class="flex justify-between mb-2">
                                    ...
                                    @if (Route::has('teacher.password.request'))
                                        <a href="{{ route('teacher.password.request') }}"
                                            class="text-sm text-gray-400 focus:text-blue-500 hover:text-blue-500 hover:underline">パスワードをお忘れの方はこちら</a>
                                    @endif
                                </div>
                        ...
                        <a href="{{ route('teacher.register') }}"
                            class="block mt-6 text-sm text-center text-blue-500 focus:outline-none focus:underline hover:underline">まだアカウントをお持ちでない方はこちら</a>
                    </div>
                </div>
            </div>
        </div>
